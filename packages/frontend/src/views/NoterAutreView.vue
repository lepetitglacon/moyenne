...
const otherMoodLabels = [
  ...
  "IL FAUT UN ADULTE (ET UN PRÊTRE)",
  "C’EST UNE JOURNÉE À DÉCLARER À L’ASSURANCE",
  "DÉGÂTS IRRÉVERSIBLES",
  "J’AI MAL POUR TOI",
  "ÇA SENT LE BURNOUT",
  "SURVIE EN MODE ÉCONOMIE D’ÉNERGIE",
  "PAS MORT MAIS PAS GLORIEUX",
  "C’EST LÉGAL MAIS IMMORAL",
  "L’UNIVERS TE TESTE (ET TU PERDS)",
  "NEUTRE : LE CŒUR NE BAT PAS, MAIS ÇA PASSE",
  ...
  "ÇA SENT LA CHANCE ILLÉGALE",
  "C’EST CARRÉMENT INDÉCENT",
  "JOURNÉE DLC : ‘BONHEUR’ ACTIVÉ",
] as const;
